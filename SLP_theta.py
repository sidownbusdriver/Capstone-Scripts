...
for i in range(20):
    ...
    theta = f1.variables['TH2'][i,:,:].squeeze()
    ...
    CS3 = plt.contourf(new_lon, new_lat, theta, np.arange(210,310,3), zorder=2)
    ...
    plt.savefig('/home/sea_ice/scripts/SLP_theta/' + titletext + '_SLP_theta', bbox_inches='tight')
...
for i in range(20):
    ...
    #plt.title("Mean Sea Level Pressure at " + time_str)
    plt.title('Mean Sea Level Pressure at ' + titletext)
    #plt.savefig('/home/sea_ice/scripts/SLP_theta/' + '_SLP_theta' + time_str_fname, bbox_inches='tight')
    plt.savefig('/home/sea_ice/scripts/SLP_theta/' + titletext + '_SLP_theta', bbox_inches='tight')
